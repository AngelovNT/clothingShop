      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Quality clothing for every occasion. Discover the latest trends and timeless classics.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/products?category=clothing" className="text-base text-gray-500 hover:text-gray-900">
                      Clothing
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/products?category=footwear" className="text-base text-gray-500 hover:text-gray-900">
                      Footwear
                    </Link>
                  </li>
                  <li>
                    <Link href="/coupons" className="text-base text-gray-500 hover:text-gray-900">
                      Coupons
                    </Link>
                  </li>
                </ul>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/track-order" className="text-base text-gray-500 hover:text-gray-900">
                      Track Order
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {currentYear} Clothing Shop. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
